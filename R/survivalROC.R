                      ...
                      window="symmetric" )
{
  ...
  x=marker
  ## changed input from x to marker, Dec 13, 2006, by Paramita Saha
  ## to make both the packages similar
...
survivalROC.C <- function(Stime, status, marker, predict.time, span=0.05)
{
  ##
